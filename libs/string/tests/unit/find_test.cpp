...
int main()
{
    ...
    HPX_TEST(((cv_result.begin() - str1.begin()) == 9) &&
    ...
    HPX_TEST(
        ((ch_result.begin() - pch1) == 9) && ((ch_result.end() - pch1) == 12));

    // find_head
    nc_result = find_head(str1, 6);
    HPX_TEST(((nc_result.begin() - str1.begin()) == 0) &&
        ((nc_result.end() - str1.begin()) == 6));
    ...
    HPX_TEST(((cv_result.begin() - str1.begin()) == 0) &&
        ((cv_result.end() - str1.begin()) == 6));

    ch_result = find_head(pch1, 6);
    HPX_TEST(
        ((ch_result.begin() - pch1) == 0) && ((ch_result.end() - pch1) == 6));
    ...
    nc_result = find_tail(str1, -6);
    HPX_TEST(((nc_result.begin() - str1.begin()) == 6) &&
        ((nc_result.end() - str1.begin()) == 21));
    ...
    HPX_TEST(
        ((ch_result.begin() - pch1) == 15) && ((ch_result.end() - pch1) == 21));
    ...
    cv_result = find_token(const_cast<const std::string&>(str1),
        is_any_of("abc"), token_compress_on);
    HPX_TEST(((cv_result.begin() - str1.begin()) == 3) &&
        ((cv_result.end() - str1.begin()) == 6));
    ...
    find_iterator<std::string::iterator> fxIt =
        make_find_iterator(s1, token_finder(is_alnum(), token_compress_on));
    ...
    cv_result =
        find_first(const_cast<const std::string&>(str2), std::string("abcd"));
    HPX_TEST(cv_result.begin() == cv_result.end());

    cv_result = find_head(const_cast<const std::string&>(str2), 4);
    HPX_TEST(
        std::string(cv_result.begin(), cv_result.end()) == std::string("abc"));
    ...
    cv_result =
        find_first(const_cast<const std::string&>(str3), std::string("abcd"));
    HPX_TEST(cv_result.begin() == cv_result.end());
    cv_result =
        find_first(const_cast<const std::string&>(str1), std::string(""));
    HPX_TEST(cv_result.begin() == cv_result.end());
