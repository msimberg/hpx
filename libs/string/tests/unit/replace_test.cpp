...
{
    // replace first
    TEST_ALGO( replace_first, "1abc3abc2", std::string("abc") C_ std::string("YYY"), std::string("1YYY3abc2") );
    TEST_ALGO( ireplace_first, "1AbC3abc2", "aBc" C_ "YYY", std::string("1YYY3abc2") );
    TEST_ALGO( replace_first, "1abc3abc2", std::string("abc") C_ std::string("Z"), std::string("1Z3abc2") );
    TEST_ALGO( replace_first, "1abc3abc2", std::string("abc") C_ std::string("XXXX"), std::string("1XXXX3abc2") );
    TEST_ALGO( replace_first, "1abc3abc2", std::string("") C_ std::string("XXXX"), std::string("1abc3abc2") );
    TEST_ALGO( replace_first, "1abc3abc2", "" C_ "XXXX", std::string("1abc3abc2") );
    TEST_ALGO( replace_first, "", std::string("") C_ std::string("XXXX"), std::string("") );
    TEST_ALGO( erase_first, "1abc3abc2", std::string("abc"), std::string("13abc2") );
    TEST_ALGO( ierase_first, "1aBc3abc2", "abC", "13abc2" );
    TEST_ALGO( erase_first, "1abc3abc2", "abc", "13abc2" );
    TEST_ALGO( erase_first, "1abc3abc2", std::string(""), std::string("1abc3abc2") );
...
{
    // replace last
    TEST_ALGO( replace_last, "1abc3abc2", std::string("abc") C_ std::string("YYY"), std::string("1abc3YYY2") );
    TEST_ALGO( ireplace_last, "1abc3AbC2", "aBc" C_ "YYY", std::string("1abc3YYY2") );
    TEST_ALGO( replace_last, "1abc3abc2", std::string("abc") C_ std::string("Z"), std::string("1abc3Z2") );
    TEST_ALGO( replace_last, "1abc3abc2", std::string("abc") C_ std::string("XXXX"), std::string("1abc3XXXX2") );
    TEST_ALGO( replace_last, "1abc3abc2", "abc" C_ "XXXX", std::string("1abc3XXXX2") );
    TEST_ALGO( replace_last, "", std::string("") C_ std::string("XXXX"), std::string("") );
    TEST_ALGO( erase_last, "1abc3abc2", std::string("abc"), std::string("1abc32") );
    TEST_ALGO( ierase_last, "1aBc3aBc2", "ABC", std::string("1aBc32") );
    TEST_ALGO( erase_last, "1abc3abc2", "abc", std::string("1abc32") );
    TEST_ALGO( erase_last, "1abc3abc2", std::string(""), std::string("1abc3abc2") );
...
{
    // replace all
    TEST_ALGO( replace_all, "1abc3abc2", std::string("abc") C_ std::string("YYY"), std::string("1YYY3YYY2") );
    TEST_ALGO( replace_all, std::string("1abc3abc2"), "/" C_ "\\", std::string("1abc3abc2") );
    TEST_ALGO( ireplace_all, "1aBc3AbC2", "abC" C_ "YYY", std::string("1YYY3YYY2") );
    TEST_ALGO( replace_all, "1abc3abc2", std::string("abc") C_ std::string("Z"), std::string("1Z3Z2") );
    TEST_ALGO( replace_all, "1abc3abc2", std::string("abc") C_ std::string("XXXX"), std::string("1XXXX3XXXX2") );
    TEST_ALGO( replace_all, "1abc3abc2", "abc" C_ "XXXX", std::string("1XXXX3XXXX2") );
    TEST_ALGO( replace_all, "", std::string("") C_ std::string("XXXX"), std::string("") );
    ...
    TEST_ALGO( erase_all, "1abc3abc2", std::string(""), std::string("1abc3abc2") );
...
{
    // replace nth
    TEST_ALGO( replace_nth, "1abc3abc2", std::string("abc") C_ 0 C_ std::string("YYY"), std::string("1YYY3abc2") );
    TEST_ALGO( replace_nth, "1abc3abc2", std::string("abc") C_ -1 C_ std::string("YYY"), std::string("1abc3YYY2") );
    TEST_ALGO( ireplace_nth, "1AbC3abc2", "aBc" C_ 0 C_ "YYY", std::string("1YYY3abc2") );
    TEST_ALGO( ireplace_nth, "1AbC3abc2", "aBc" C_ -1 C_ "YYY", std::string("1AbC3YYY2") );
    TEST_ALGO( replace_nth, "1abc3abc2", std::string("abc") C_ 0 C_ std::string("Z"), std::string("1Z3abc2") );
    TEST_ALGO( replace_nth, "1abc3abc2", std::string("abc") C_ 0 C_ std::string("XXXX"), std::string("1XXXX3abc2") );
    TEST_ALGO( replace_nth, "1abc3abc2", "abc" C_ 0 C_ "XXXX", std::string("1XXXX3abc2") );
    TEST_ALGO( replace_nth, "1abc3abc2", "abc" C_ 3 C_ "XXXX", std::string("1abc3abc2") );
    TEST_ALGO( replace_nth, "1abc3abc2", "abc" C_ -3 C_ "XXXX", std::string("1abc3abc2") );
    TEST_ALGO( replace_nth, "1abc3abc2", std::string("") C_ 0 C_ std::string("XXXX"), std::string("1abc3abc2") );
    TEST_ALGO( replace_nth, "", std::string("") C_ 0 C_ std::string("XXXX"), std::string("") );
    TEST_ALGO( replace_nth, "", std::string("") C_ -1 C_ std::string("XXXX"), std::string("") );
    TEST_ALGO( erase_nth, "1abc3abc2", std::string("abc") C_ 0, std::string("13abc2") );
    TEST_ALGO( erase_nth, "1abc3abc2", std::string("abc") C_ -1, std::string("1abc32") );
    TEST_ALGO( erase_nth, "1abc3abc2", std::string("abc") C_ -3, std::string("1abc3abc2") );
    ...
    TEST_ALGO( erase_nth, "1abc3abc2", std::string("") C_ 0, std::string("1abc3abc2") );
    TEST_ALGO( erase_nth, "", std::string("abc") C_ 0, std::string("") );
    TEST_ALGO( erase_nth, "", std::string("abc") C_ -1, std::string("") );
    TEST_ALGO( replace_nth, "1abc3abc2", std::string("abc") C_ 1 C_ std::string("YYY"), std::string("1abc3YYY2") );
    TEST_ALGO( replace_nth, "1abc3abc2", std::string("abc") C_ 2 C_ std::string("YYY"), std::string("1abc3abc2") );
}

void replace_head_test()
{
    // replace head
    TEST_ALGO( replace_head, "abc3abc2", 3 C_ std::string("YYY"), std::string("YYY3abc2") );
    TEST_ALGO( replace_head, "abc3abc2", -3 C_ std::string("YYY"), std::string("YYYbc2") );
    TEST_ALGO( replace_head, "abc3abc2", 3 C_ "YYY", std::string("YYY3abc2") );
    TEST_ALGO( replace_head, "abc", 3 C_ std::string("Z"), std::string("Z") );
    TEST_ALGO( replace_head, "abc", 6 C_ std::string("XXXX"), std::string("XXXX") );
    TEST_ALGO( replace_head, "abc", -6 C_ std::string("XXXX"), std::string("abc") );
    TEST_ALGO( replace_head, "abc3abc2", 0 C_ std::string("XXXX"), std::string("abc3abc2") );
...
{
    // replace tail
    TEST_ALGO( replace_tail, "abc3abc", 3 C_ std::string("YYY"), std::string("abc3YYY") );
    TEST_ALGO( replace_tail, "abc3abc", -3 C_ "YYY", std::string("abcYYY") );
    TEST_ALGO( replace_tail, "abc", 3 C_ std::string("Z"), std::string("Z") );
    TEST_ALGO( replace_tail, "abc", 6 C_ std::string("XXXX"), std::string("XXXX") );
    TEST_ALGO( replace_tail, "abc", -6 C_ std::string("XXXX"), std::string("abc") );
    TEST_ALGO( replace_tail, "abc3abc", 0 C_ std::string("XXXX"), std::string("abc3abc") );
...
void replace_range_test()
{
    ...
    // erase_range
    {
        ...
        erase_range_copy(
                str1,
                boost::make_iterator_range(str1.begin()+1, str1.begin()+4))==std::string("13abc2") );
