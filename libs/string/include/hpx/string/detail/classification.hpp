...
namespace hpx { namespace string { namespace detail {
    ...
    struct is_classifiedF : public predicate_facade<is_classifiedF>
    {
        ...
        is_classifiedF(
            std::ctype_base::mask Type, std::locale const& Loc = std::locale())
          : m_Type(Type)
          , m_Locale(Loc)
        {
        }
    ...
    public:
        ...
        // Copy constructor
        is_any_ofF(const is_any_ofF& Other)
          : m_Size(Other.m_Size)
        {
            // Prepare storage
            m_Storage.m_dynSet = nullptr;
            ...
            // Use fixed storage
            ::std::memcpy(
                DestStorage, SrcStorage, sizeof(set_value_type) * m_Size);
        }
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        set_value_type* pTemp =
                            new set_value_type[Other.m_Size];
                        DestStorage = pTemp;
