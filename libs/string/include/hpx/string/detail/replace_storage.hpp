...
namespace hpx { namespace string { namespace detail {
    ...
    inline OutputIteratorT move_from_storage(
        StorageT& Storage, OutputIteratorT DestBegin, OutputIteratorT DestEnd)
    {
    ...
    struct process_segment_helper
    {
        ...
        ForwardIteratorT operator()(StorageT& Storage, InputT& /*Input*/,
            ForwardIteratorT InsertIt, ForwardIteratorT SegmentBegin,
            ForwardIteratorT SegmentEnd)
        {
            // Copy data from the storage until the beginning of the segment
            ForwardIteratorT It = ::hpx::string::detail::move_from_storage(
                Storage, InsertIt, SegmentBegin);
    ...
    struct process_segment_helper<true>
    {
...

        {
            ...
            ::hpx::string::detail::replace(
                Input, InsertIt, SegmentBegin, Storage);
            // Empty the storage
            Storage.clear();
