...
namespace hpx { namespace string { namespace detail {
    ...
    inline OutputIteratorT find_format_copy_impl2(OutputIteratorT Output,
        const InputT& Input, FormatterT Formatter,
        const FindResultT& FindResult, const FormatResultT& FormatResult)
    {
        typedef find_format_store<
            typename boost::range_const_iterator<InputT>::type, FormatterT,
            FormatResultT>
            store_type;
    ...
    inline OutputIteratorT find_format_copy_impl(OutputIteratorT Output,
        const InputT& Input, FormatterT Formatter,
        const FindResultT& FindResult)
    {
        if (::hpx::string::detail::check_find_result(Input, FindResult))
        {
            return ::hpx::string::detail::find_format_copy_impl2(
                Output, Input, Formatter, FindResult, Formatter(FindResult));
        }
        else
        {
            return std::copy(
    ...
    inline InputT find_format_copy_impl2(const InputT& Input,
        ...
        const FormatResultT& FormatResult)
    {
        ...
        hpx::string::detail::insert(
            Output, ::boost::end(Output), ::boost::begin(Input), M.begin());
        // Copy formatted result
        hpx::string::detail::insert(
            Output, ::boost::end(Output), M.format_result());
        // Copy the rest of the sequence
        hpx::string::detail::insert(
            Output, ::boost::end(Output), M.end(), ::boost::end(Input));

        return Output;
    }

    template <typename InputT, typename FormatterT, typename FindResultT>
    inline InputT find_format_copy_impl(const InputT& Input,
        FormatterT Formatter, const FindResultT& FindResult)
    {
        if (::hpx::string::detail::check_find_result(Input, FindResult))
        {
    ...
    inline void find_format_impl2(InputT& Input, FormatterT Formatter,
        const FindResultT& FindResult, const FormatResultT& FormatResult)
    {
        typedef find_format_store<typename boost::range_iterator<InputT>::type,
            FormatterT, FormatResultT>
            store_type;
        ...
        ::hpx::string::detail::replace(
            Input, M.begin(), M.end(), M.format_result());
    }

    template <typename InputT, typename FormatterT, typename FindResultT>
    inline void find_format_impl(
        InputT& Input, FormatterT Formatter, const FindResultT& FindResult)
    {
        if (::hpx::string::detail::check_find_result(Input, FindResult))
        {
