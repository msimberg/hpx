...
namespace hpx { namespace string {
    ...
    inline bool starts_with(
        const Range1T& Input, const Range2T& Test, PredicateT Comp)
    {
        ...
        typedef typename boost::range_const_iterator<Range1T>::type Iterator1T;
        typedef typename boost::range_const_iterator<Range2T>::type Iterator2T;
    ...
    inline bool starts_with(const Range1T& Input, const Range2T& Test)
    {
        ...
        const Range1T& Input, const Range2T& Test, PredicateT Comp)
    {
        ...
        typedef typename boost::detail::iterator_traits<
            Iterator1T>::iterator_category category;

        return detail::ends_with_iter_select(::boost::begin(lit_input),
            ::boost::end(lit_input), ::boost::begin(lit_test),
            ::boost::end(lit_test), Comp, category());
    }
        ...
        const Range1T& Input, const Range2T& Test, PredicateT Comp)
    {
        ...
        bool bResult = (::hpx::string::first_finder(lit_test, Comp)(
    ...
    /*!
        ...
        */
    template <typename Range1T, typename Range2T>
    inline bool iequals(const Range1T& Input, const Range2T& Test,
        const std::locale& Loc = std::locale())
    {
    ...
    inline bool lexicographical_compare(
        const Range1T& Arg1, const Range2T& Arg2, PredicateT Pred)
    {
        boost::iterator_range<
            typename boost::range_const_iterator<Range1T>::type>
        ...
        return std::lexicographical_compare(::boost::begin(lit_arg1),
            ::boost::end(lit_arg1), ::boost::begin(lit_arg2),
            ::boost::end(lit_arg2), Pred);
    }
    ...
    template <typename Range1T, typename Range2T>
    inline bool lexicographical_compare(
        const Range1T& Arg1, const Range2T& Arg2)
    {
    ...
    /*!
         ...
         */
    template <typename Range1T, typename Range2T>
    inline bool ilexicographical_compare(const Range1T& Arg1,
        const Range2T& Arg2, const std::locale& Loc = std::locale())
    {
        return ::hpx::string::lexicographical_compare(
            Arg1, Arg2, is_iless(Loc));
    }
    ...
    inline bool all(const RangeT& Input, PredicateT Pred)
    {
        ...
        typedef typename boost::range_const_iterator<RangeT>::type Iterator1T;
