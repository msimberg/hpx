...
int main()
{
    ...
    std::cout << "str1 without 6th to 9th character:" <<
        hpx::string::erase_range_copy( str1, boost::make_iterator_range(str1.begin()+6, str1.begin()+9) ) << std::endl;

    // Replace 6-9th character with '+++'
    std::cout << "str1 with 6th to 9th character replaced with '+++': " <<
        hpx::string::replace_range_copy(
            str1, boost::make_iterator_range(str1.begin()+6, str1.begin()+9), "+++" ) << std::endl;

    std::cout << "str1 with 'cde' replaced with 'XYZ': ";

    // Replace first 'cde' with 'XYZ'. Modify the input
    hpx::string::replace_first_copy( std::ostream_iterator<char>(std::cout), str1, "cde", "XYZ" );
    std::cout << std::endl;
    ...
    std::cout << "str1 with third and 5th occurrence of _ replace: " << str1 << std::endl;
