...
namespace hpx { namespace detail {
    ...
    template <typename Exception>
    HPX_CORE_EXPORT std::exception_ptr construct_custom_exception(Exception const& e,
    ...
    template <typename Exception>
    HPX_CORE_EXPORT void throw_exception(Exception const& e, std::string const& func,
    ...
    ///////////////////////////////////////////////////////////////////////////
    template HPX_CORE_EXPORT std::exception_ptr get_exception(hpx::exception const&,
    ...
    template HPX_CORE_EXPORT std::exception_ptr get_exception(std::exception const&,
        std::string const&, std::string const&, long, std::string const&);
    template HPX_CORE_EXPORT std::exception_ptr get_exception(
    ...
    template HPX_CORE_EXPORT std::exception_ptr get_exception(
        ...
        std::string const&, long, std::string const&);
    template HPX_CORE_EXPORT std::exception_ptr get_exception(std::bad_typeid const&,
        std::string const&, std::string const&, long, std::string const&);
    template HPX_CORE_EXPORT std::exception_ptr get_exception(
        hpx::detail::bad_typeid const&, std::string const&, std::string const&,
        long, std::string const&);
    template HPX_CORE_EXPORT std::exception_ptr get_exception(std::bad_cast const&,
        std::string const&, std::string const&, long, std::string const&);
    template HPX_CORE_EXPORT std::exception_ptr get_exception(
        hpx::detail::bad_cast const&, std::string const&, std::string const&,
        long, std::string const&);
    template HPX_CORE_EXPORT std::exception_ptr get_exception(std::bad_alloc const&,
        std::string const&, std::string const&, long, std::string const&);
    template HPX_CORE_EXPORT std::exception_ptr get_exception(
    ...
    template HPX_CORE_EXPORT void throw_exception(boost::system::system_error const&,
        std::string const&, std::string const&, long);

    template HPX_CORE_EXPORT void throw_exception(
        std::exception const&, std::string const&, std::string const&, long);
    template HPX_CORE_EXPORT void throw_exception(hpx::detail::std_exception const&,
        std::string const&, std::string const&, long);
    template HPX_CORE_EXPORT void throw_exception(std::bad_exception const&,
        std::string const&, std::string const&, long);
    template HPX_CORE_EXPORT void throw_exception(hpx::detail::bad_exception const&,
        std::string const&, std::string const&, long);
    template HPX_CORE_EXPORT void throw_exception(
        std::bad_typeid const&, std::string const&, std::string const&, long);
    template HPX_CORE_EXPORT void throw_exception(hpx::detail::bad_typeid const&,
        std::string const&, std::string const&, long);
    template HPX_CORE_EXPORT void throw_exception(
