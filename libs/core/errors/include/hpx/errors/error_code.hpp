...
namespace hpx {
    ...
    HPX_CORE_EXPORT boost::system::error_category const& get_hpx_rethrow_category();
    ...
    public:
        ...
        HPX_CORE_EXPORT error_code(error e, char const* msg, throwmode mode = plain);
        ...
        /// \throws std#bad_alloc (if allocation of a copy of
        ///         the passed string fails).
        HPX_CORE_EXPORT error_code(error e, std::string const& msg, char const* func,
            char const* file, long line, throwmode mode = plain);
