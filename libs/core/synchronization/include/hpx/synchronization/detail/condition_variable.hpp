...
namespace hpx { namespace lcos { namespace local { namespace detail {
    ...
    public:
        ...
        HPX_CORE_EXPORT bool empty(std::unique_lock<mutex_type> const& lock) const;
    ...
    private:
        friend HPX_CORE_EXPORT void intrusive_ptr_add_ref(condition_variable_data*);
        friend HPX_CORE_EXPORT void intrusive_ptr_release(condition_variable_data*);
