...
/// \param msg  The optional message that is used to give further information
///             if the assert fails. This should be convertible to a std::string
///
...
/// being aborted. The assertion handler can be costumized by calling
/// \a hpx::assertion::set_assertion_handler().
///
/// Asserts are enabled if \a HPX_DEBUG is set. This is the default for `CMAKE_BUILD_TYPE=Debug`
