...
<https://stellar-group.github.io/hpx-docs/latest/html/modules/{module_name}/docs/index.html>`__.
'''
...
# Default location is $HPX_ROOT/modules/{module_name}/include
set({module_name}_headers)

# Default location is $HPX_ROOT/modules/{module_name}/include_compatibility
...
# modules/create_module_skeleton.py script.
'''
...
'''
for module in modules:
    modules_rst += f'   /modules/{lib_name}/{module}/docs/index.rst\n'
