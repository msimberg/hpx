...
int main(int argc, char* argv[])
{
    ...
    std::cout << "launching local" << std::endl;
    test_scheduler(argc, argv, hpx::resource::scheduling_policy::local);
    std::cout << "launching local_priority_lifo" << std::endl;
    test_scheduler(argc, argv,
        hpx::resource::scheduling_policy::local_priority_lifo);
    std::cout << "launching local_priority_fifo" << std::endl;
    test_scheduler(argc, argv,
