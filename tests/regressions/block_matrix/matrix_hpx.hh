  ...
  hpx::components::client_base<vector_t_client, vector_t_server>
{
  ...
  {
    return hpx::async(vector_t_server::axpy_action(), get_id(),
                      alpha, x.get_id());
  }
  ...
  hpx::components::client_base<matrix_t_client, matrix_t_server>
{
  ...
  hpx::future<void> axpy(bool trans, double alpha, const matrix_t_client& a)
    const
  {
    return hpx::async(matrix_t_server::axpy_action(), get_id(),
                      trans, alpha, a.get_id());
  }
  hpx::future<void> copy(bool transa, const matrix_t_client& a) const
  {
    return hpx::async(matrix_t_server::copy_action(), get_id(),
                      transa, a.get_id());
  }
  hpx::future<void> gemm(bool transa, bool transb, double alpha,
                         ...
                         double beta) const
  {
    return hpx::async(matrix_t_server::gemm_action(), get_id(),
                      transa, transb, alpha, a.get_id(), b.get_id(), beta);
  }
